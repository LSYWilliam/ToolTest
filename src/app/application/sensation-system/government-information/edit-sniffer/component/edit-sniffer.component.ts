...
@Component({
    ...
    templateUrl: './edit-sniffer.component.html',
    styleUrls: ['./edit-sniffer.component.scss'],
    animations: [routerTransition()],
    host: {'[@routerTransition]': ''}
})

export class EditSnifferComponent extends EditSnifferService implements OnInit {
    ...
    /**验证主题名称输入框是否输入正确*/
    themeValidate(event) {
        const regContact = /^[a-zA-Z\u4e00-\u9fa5]{2,16}$/;
