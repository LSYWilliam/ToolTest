 ...
 */
@Injectable()
export class MenuResolverService implements Resolve<ReceiveModel> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<ReceiveModel> {
        ...
        requestArgs.url = '/ewifi/system/console/permission/find_user_menu_permission';
        requestArgs.header = {'ticket':sessionStorage.getItem('ticket') };
        requestArgs.body = {'permissionSystem': 'wlanscope'};
