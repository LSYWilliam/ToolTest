...
@Component
({
    selector: 'app-ssid-conf-copy',
    templateUrl: './ssid-conf-copy.component.html',
    styleUrls: ['./ssid-conf-copy.component.scss'],
    animations: [routerTransition()],
    host: {'[@routerTransition]': ''}
})

export class SsidConfCopyComponent implements OnDestroy {
    ...
    /** 回退按钮事件 */
    public goBack() {
        this.router.navigate(['/ssid-details-copy/', this.netId]);
    }
