...
@Injectable()
export class ManageMySnifferService {
    ...
    public getTopicData() {
        this.requestArgs.url = "/crawler/crawler-theme-info/gov-do-find-list";
        this.requestArgs.body = {};
        return this.http.httpPost(this.requestArgs);
    }

    public delTopicData(topicID: any) {
        this.requestArgs.url = "/crawler/crawler-theme-info/gov-do-delete";
