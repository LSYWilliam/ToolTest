...
@Component({
    selector: 'app-manage-my-theme',
    templateUrl: './manage-my-theme.component.html',
    styleUrls: ['./manage-my-theme.component.scss'],
    animations: [routerTransition()],
    host: {'[@routerTransition]': ''}
})

export class ManageMyThemeComponent extends ManageMyThemeService implements OnInit {
    /**表格静态数据 实体类*/
    ...
    private jumpToUrl(status: string, data: any) {
        this.router.navigate(["/edit-topic", status, data, "/manage-my-theme"],
