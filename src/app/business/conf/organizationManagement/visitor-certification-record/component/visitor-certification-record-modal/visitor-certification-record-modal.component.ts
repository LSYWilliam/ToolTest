...
@Component({
    selector: 'app-visitor-certification-record-modal',
    templateUrl: './visitor-certification-record-modal.component.html',
    styleUrls: ['./visitor-certification-record-modal.component.scss']
})
export class VisitorCertificationRecordModalComponent implements OnInit {
