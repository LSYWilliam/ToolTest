...
@Injectable()
export class EditSnifferService {
    /**判断是 新建 or 编辑 */
    public flag: string;
    /**点击回退按钮, 退到的页面*/
    public url: string;
    ...
    public getTopicData(topicID: string) {
        this.requestArgs.url = "/crawler/crawler-theme-info/gov-find-crawler-theme-info";
    ...
    public createTopic(topicData: TopicModel) {
        this.requestArgs.url = "/crawler/crawler-theme-info/gov-do-create";
        this.requestArgs.body = topicData.getCreateJson();
        return  this.http.httpPost(this.requestArgs);
    }

    public editTopic(data: any) {
        this.requestArgs.url = "/crawler/crawler-theme-info/gov-do-edit";
