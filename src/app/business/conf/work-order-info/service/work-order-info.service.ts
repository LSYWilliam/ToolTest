...
import {InstallRecordDetailModelItem} from "../model/work-order-info.model";
...
export class WorkOrderInfoService {
    ...
    /** 表格数据 */
    public installRecordListModel: Array<InstallRecordDetailModelItem> = new Array<InstallRecordDetailModelItem>();
